...
.PHONY: default
default: dirs $(WHITE_ON_BLACK_SVG_ROUTE_ICONS) $(BLACK_ON_YELLOW_SVG_ROUTE_ICONS) $(WHITE_ON_BLACK_PNG_ROUTE_ICONS) $(BLACK_ON_YELLOW_PNG_ROUTE_ICONS)

.PHONY: svgs
svgs: dirs $(WHITE_ON_BLACK_SVG_ROUTE_ICONS) $(BLACK_ON_YELLOW_SVG_ROUTE_ICONS)

.PHONY: pngs
pngs: dirs $(WHITE_ON_BLACK_PNG_ROUTE_ICONS) $(BLACK_ON_YELLOW_PNG_ROUTE_ICONS)
