...
WHITE_ON_BLUE_SVG_ROUTE_ICONS   = $(shell (seq 0 99; echo 00; echo XX) | sed -r 's:(.*):target/route-icons/svg/white-on-blue/\1.svg:g')
...
BLUE_ON_WHITE_SVG_ROUTE_ICONS   = $(shell (seq 0 99; echo 00; echo XX) | sed -r 's:(.*):target/route-icons/svg/blue-on-white/\1.svg:g')

WHITE_ON_BLACK_PNG_ROUTE_ICONS  = $(shell (seq 0 99; echo 00; echo XX) | sed -r 's:(.*):target/route-icons/png/white-on-black/\1.png:g')
WHITE_ON_BLUE_PNG_ROUTE_ICONS   = $(shell (seq 0 99; echo 00; echo XX) | sed -r 's:(.*):target/route-icons/png/white-on-blue/\1.png:g')
...
BLUE_ON_WHITE_PNG_ROUTE_ICONS   = $(shell (seq 0 99; echo 00; echo XX) | sed -r 's:(.*):target/route-icons/png/blue-on-white/\1.png:g')
